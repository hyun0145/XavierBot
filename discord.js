...
const TOKEN = 'MTQyNDQ5NTU5NjkyMzkxNjI4OA.G3q9FF.aqsHkJmFJJqxTAdIA2g7lqGzA8zJM2Pt-pVRGI'; // Your bot token
...
- **v1.3.0 (2025-11-10):** // ADDED: New changelog entry
    ...
    // --- Communication Commands ---
        ...
        try {
            ...
            message.reply(`Failed to send a direct message to ${user.tag}. They might have DMs disabled. Sending message in this channel instead as a fallback.`);
            message.channel.send(`${user.toString()}, you have a message from ${message.author.toString()}: ${dmMessageContent}`);
        }
    }
